// perawat/lapor_it.dart
// ✅ Halaman Lapor IT untuk Perawat
// ✅ Design system konsisten dengan PerawatDashboard
...
class LaporITPagePerawat extends StatefulWidget {
  const LaporITPagePerawat({Key? key}) : super(key: key);

  @override
  State<LaporITPagePerawat> createState() => _LaporITPagePerawatState();
}

class _LaporITPagePerawatState extends State<LaporITPagePerawat> {
  // ====== DESIGN SYSTEM (SAMA DENGAN PERAWAT DASHBOARD) ======
  ...
  Future<void> _submitReport() async {
    ...
    try {
      ...
      final payload = {
        ...
        'platform': _platform(),
        'app_version': null,
        'meta': {'source': 'perawat.lapor_it', 'is_web': kIsWeb},
      };
  ...
  void _goToHistory() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const RiwayatLaporanITPagePerawat(),
      ),
    );
  }
  ...
  Widget _buildSubjectField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: 'Contoh: Aplikasi perawat tidak bisa login',
        hintStyle: TextStyle(
          fontSize: 14,
...
// ===============================
// RIWAYAT LAPORAN IT PAGE PERAWAT
// ===============================
class RiwayatLaporanITPagePerawat extends StatefulWidget {
  const RiwayatLaporanITPagePerawat({Key? key}) : super(key: key);

  @override
  State<RiwayatLaporanITPagePerawat> createState() =>
      _RiwayatLaporanITPagePerawatState();
}

class _RiwayatLaporanITPagePerawatState
    extends State<RiwayatLaporanITPagePerawat> {
  // ====== DESIGN SYSTEM ======
  static const Color kBg = Color(0xFFF8FAFC);
  static const Color kCard = Colors.white;
  static const Color kBorder = Color(0xFFE2E8F0);
