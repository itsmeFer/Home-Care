...
class _DashboardOverviewScreenState extends State<DashboardOverviewScreen>
  ...
  @override
  void didUpdateWidget(covariant DashboardOverviewScreen oldWidget) {
  ...
  Future<Map<String, dynamic>> _fetch() async {
    final endpoint = '/${widget.role}/dashboard/overview';
    final res = await ApiClient.get(
      endpoint,
      queryParams: {'range': _rangeParam(widget.range)},
    );
