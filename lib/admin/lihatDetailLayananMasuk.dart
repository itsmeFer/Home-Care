  ...
  Future<void> _assignKoordinator() async {
    if (_selectedKoordinatorId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Silakan pilih koordinator terlebih dahulu.'),
        ),
      );
      return;
    }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (success) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Koordinator berhasil ditugaskan.')),
          );

          // beri sinyal ke halaman list supaya refresh
      ...
      child: ListView(
        ...
        children: [
          ...
          _section(
            'Koordinator',
            children: [
              _row('Nama koordinator sekarang', _getNama(koordinator)),
          ...
          _section(
            'Perawat',
            children: [
              _row('Nama perawat', _getNama(perawat)),
      ...
      children: [
        ...
        Align(
          ...
          child: ElevatedButton.icon(
            onPressed: _isAssigningKoordinator ? null : _assignKoordinator,
            ...
            label: Text(
              _isAssigningKoordinator ? 'Menyimpan...' : 'Simpan Penugasan',
            ),
          ),
        ),
      ],
