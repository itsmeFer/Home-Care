...
class LayananFormDialog extends StatefulWidget {
  final Layanan? layanan;
  final List<KategoriLayananItem> kategoriList;

  const LayananFormDialog({
    super.key,
    this.layanan,
  ...
  @override
  State<LayananFormDialog> createState() => _LayananFormDialogState();
}

class _LayananFormDialogState extends State<LayananFormDialog> {
