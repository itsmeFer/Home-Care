...
class LaporITPage extends StatefulWidget {
  const LaporITPage({Key? key}) : super(key: key);

  @override
  State<LaporITPage> createState() => _LaporITPageState();
}

class _LaporITPageState extends State<LaporITPage> {
  ...
  void _goToHistory() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const RiwayatLaporanITPage(),
      ),
    );
  }
  ...
  Widget _buildSubjectField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: 'Contoh: Dashboard tidak bisa dibuka',
        hintStyle: TextStyle(
          fontSize: 14,
...
// ===============================
// RIWAYAT LAPORAN IT PAGE
// ===============================
class RiwayatLaporanITPage extends StatefulWidget {
  const RiwayatLaporanITPage({Key? key}) : super(key: key);

  @override
  State<RiwayatLaporanITPage> createState() => _RiwayatLaporanITPageState();
}

class _RiwayatLaporanITPageState extends State<RiwayatLaporanITPage> {
  // ====== DESIGN SYSTEM ======
  static const Color kBg = Color(0xFFF8FAFC);
  static const Color kCard = Colors.white;
  static const Color kBorder = Color(0xFFE2E8F0);
      ...
      return Center(
        child: Padding(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.error_outline, size: 64, color: kDanger.withOpacity(0.5)),
              const SizedBox(height: 16),
              Text(
                _errorMessage!,
                textAlign: TextAlign.center,
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _buildFilterChip('Diproses', 'in_progress', _filterStatus, (val) {
                  setState(() => _filterStatus = val);
                }),
