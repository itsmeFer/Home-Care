...
/// Model sederhana untuk order di sisi Koordinator
class OrderKoordinator {
  ...
  final String? jamMulai; // "HH:mm:ss" atau "HH:mm"
...
class LihatOrderanMasukKoordinatorPage extends StatefulWidget {
  const LihatOrderanMasukKoordinatorPage({Key? key}) : super(key: key);
...
class _LihatOrderanMasukKoordinatorPageState
  ...
  Future<void> _fetchOrders() async {
    ...
    try {
      ...
      if (keyword.isNotEmpty) {
        // pastikan backend support ?search=
      ...
      if (queryParams.isEmpty) {
        uri = Uri.parse('$kBaseUrl/koordinator/order-layanan');
      } else {
        uri = Uri.parse('$kBaseUrl/koordinator/order-layanan')
      ...
      if (response.statusCode == 200) {
        ...
        final list =
            data.map((e) => OrderKoordinator.fromJson(e)).toList();
  ...
  /// 📅 Label ringkas untuk range tanggal di UI
  ...
  /// 📅 Pilih rentang tanggal pakai DateRangePicker
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText:
                        'Cari kode order / nama pasien / perawat / layanan...',
                  ),
  ...
  Widget _buildBody() {
    ...
    if (_orders.isEmpty) {
      return const Center(
        child: Text('Belum ada order masuk untuk koordinator ini.'),
      );
    }
