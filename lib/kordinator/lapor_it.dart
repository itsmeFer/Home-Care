...
class LaporITPageKoordinator extends StatefulWidget {
  const LaporITPageKoordinator({Key? key}) : super(key: key);

  @override
  State<LaporITPageKoordinator> createState() => _LaporITPageKoordinatorState();
}
...
class _LaporITPageKoordinatorState extends State<LaporITPageKoordinator> {
  ...
  Future<void> _submitReport() async {
    ...
    try {
      ...
      final payload = {
        ...
        'platform': _platform(),
        'app_version': null,
        'meta': {'source': 'koordinator.lapor_it', 'is_web': kIsWeb},
      };
  ...
  void _goToHistory() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const RiwayatLaporanITPageKoordinator(),
      ),
    );
  }
  ...
  Widget _buildSubjectField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: 'Contoh: Dashboard koordinator tidak bisa dibuka',
        hintStyle: TextStyle(
          fontSize: 14,
...
class RiwayatLaporanITPageKoordinator extends StatefulWidget {
  ...
  @override
  State<RiwayatLaporanITPageKoordinator> createState() =>
      _RiwayatLaporanITPageKoordinatorState();
}
