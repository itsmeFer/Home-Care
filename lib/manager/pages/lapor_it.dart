// manager/pages/lapor_it.dart
// ✅ Halaman Lapor IT untuk Manager
// ✅ Design system konsisten dengan ManagerDashboard
...
class LaporITPageManager extends StatefulWidget {
  const LaporITPageManager({Key? key}) : super(key: key);

  @override
  State<LaporITPageManager> createState() => _LaporITPageManagerState();
}

class _LaporITPageManagerState extends State<LaporITPageManager> {
  ...
  Future<void> _submitReport() async {
    ...
    try {
      ...
      final payload = {
        ...
        'platform': _platform(),
        'app_version': null,
        'meta': {'source': 'manager.lapor_it', 'is_web': kIsWeb},
      };
  ...
  void _goToHistory() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const RiwayatLaporanITPageManager(),
      ),
    );
  }
  ...
  Widget _buildSubjectField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: 'Contoh: Dashboard manager tidak bisa dibuka',
        hintStyle: TextStyle(
          fontSize: 14,
...
// ===============================
class RiwayatLaporanITPageManager extends StatefulWidget {
  const RiwayatLaporanITPageManager({Key? key}) : super(key: key);

  @override
  State<RiwayatLaporanITPageManager> createState() =>
      _RiwayatLaporanITPageManagerState();
}

class _RiwayatLaporanITPageManagerState
    extends State<RiwayatLaporanITPageManager> {
  // ====== DESIGN SYSTEM ======
  static const Color kBg = Color(0xFFF8FAFC);
  static const Color kCard = Colors.white;
  static const Color kBorder = Color(0xFFE2E8F0);
