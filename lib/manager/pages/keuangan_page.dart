...
class ManagerKeuanganPage extends StatefulWidget {
  ...
  @override
  State<ManagerKeuanganPage> createState() => _ManagerKeuanganPageState();
}
...
class _ManagerKeuanganPageState extends State<ManagerKeuanganPage>
  ...
  @override
  void didUpdateWidget(covariant ManagerKeuanganPage oldWidget) {
  ...
  Future<void> _exportKeuangan(Map<String, dynamic> data) async {
    try {
      ...
      final List perLayananRaw = (data['profit_per_layanan'] is List)
      ...
      final marginP = (kpi['margin_percent'] != null)
